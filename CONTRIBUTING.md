...
The [author README](authors/README.md) is auto-generated based on the schema file. It can be used to see which fields are required and what each field is for.
